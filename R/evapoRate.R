...
evapoRate <- function(
  ...
  if (gas_exchange_mode == "none") {
    ...
    output$Fgas <- Fgas
    output$a_H <- phreeqc_output2$n1$la_H.[2]
    output$a_Mg <- phreeqc_output2$n1$la_Mg.2[2]
    output$a_Si <- phreeqc_output2$n1$la_H4SiO4[2]
    output$a_H2O <- phreeqc_output2$n1$la_H2O[2]
